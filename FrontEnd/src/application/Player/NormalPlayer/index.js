    ...
    >
      <NormalPlayerContainer ref={normalPlayerRef}>
        ...
        <Bottom className="bottom">
          <List>
            <span style={{color:'#b17272'}}>Speed</span>
            {
              list.map((item) => {
                return (
                  <ListItem 
...
export default connect((state)=>({isPlayingMv: state.getIn(['mvPlayer', 'isPlayingMv'])}) ,null)(withRouter(React.memo(NormalPlayer)))